...
QColor Styles::getColorByIndex(int idx)
{
    if (m_indexedColors.isEmpty()) {
        m_indexedColors = {
            QColor(0xFF000000), QColor(0xFFFFFFFF),
            QColor(0xFFFF0000), QColor(0xFF00FF00),
            QColor(0xFF0000FF), QColor(0xFFFFFF00),
            QColor(0xFFFF00FF), QColor(0xFF00FFFF),
            QColor(0xFF000000), QColor(0xFFFFFFFF),
            QColor(0xFFFF0000), QColor(0xFF00FF00),
            QColor(0xFF0000FF), QColor(0xFFFFFF00),
            QColor(0xFFFF00FF), QColor(0xFF00FFFF),
            QColor(0xFF800000), QColor(0xFF008000),
            QColor(0xFF000080), QColor(0xFF808000),
            QColor(0xFF800080), QColor(0xFF008080),
            QColor(0xFFC0C0C0), QColor(0xFF808080),
            QColor(0xFF9999FF), QColor(0xFF993366),
            QColor(0xFFFFFFCC), QColor(0xFFCCFFFF),
            QColor(0xFF660066), QColor(0xFFFF8080),
            QColor(0xFF0066CC), QColor(0xFFCCCCFF),
            QColor(0xFF000080), QColor(0xFFFF00FF),
            QColor(0xFFFFFF00), QColor(0xFF00FFFF),
            QColor(0xFF800080), QColor(0xFF800000),
            QColor(0xFF008080), QColor(0xFF0000FF),
            QColor(0xFF00CCFF), QColor(0xFFCCFFFF),
            QColor(0xFFCCFFCC), QColor(0xFFFFFF99),
            QColor(0xFF99CCFF), QColor(0xFFFF99CC),
            QColor(0xFFCC99FF), QColor(0xFFFFCC99),
            QColor(0xFF3366FF), QColor(0xFF33CCCC),
            QColor(0xFF99CC00), QColor(0xFFFFCC00),
            QColor(0xFFFF9900), QColor(0xFFFF6600),
            QColor(0xFF666699), QColor(0xFF969696),
            QColor(0xFF003366), QColor(0xFF339966),
            QColor(0xFF003300), QColor(0xFF333300),
            QColor(0xFF993300), QColor(0xFF993366),
            QColor(0xFF333399), QColor(0xFF333333),
        };
        m_isIndexedColorsDefault = true;
    }
    if (idx < 0 || idx >= m_indexedColors.size())
